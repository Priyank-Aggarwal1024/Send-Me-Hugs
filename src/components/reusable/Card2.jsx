...
function Card2({ item }) {
    return (
        <>
            <div className="p-[15px_16px] flex gap-1 bg-[rgba(50,87,101,0.40)] rounded-[8px]">
                ...
                <div className="w-[22px]">
                    <svg className={`${!item.arrow && "hidden"}`} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
