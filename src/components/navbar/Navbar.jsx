...
function Navbar({ navOpen, setNavOpen }) {
    ...
    return (
        <>
            <nav className="max-w-[1512px] bg-dark-cyan p-[10px_16px] h-[78px] sm:p-[10px_32px] xl:p-[15px_96px] mx-auto 2xl:p-[15px_156px] flex justify-between items-center fixed z-[20] w-[100%]">
