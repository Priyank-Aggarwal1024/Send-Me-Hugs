...
function SideNav(props) {
    const linkStyle = ({ isActive }) => {
        return {
            ...
            padding: isActive ? "4px 8px" : "5px 9px",
        ...
        <div className="w-[260px] min-h-[100vh] pb-5 bg-white border-r border-[#d0d0d0] flex-col justify-start items-start gap-[22px] inline-flex">
            ...
            <div className="self-stretch h-[310px] px-3 flex-col justify-start items-start gap-5 flex">
                <NavLink to="/dashboard" className="group self-stretch px-[9px] py-[5px] hover:px-2 hover:py-1 rounded hover:border hover:border-[#d9d9d9] justify-start items-center gap-2 inline-flex" style={linkStyle}>
                    ...
                    <div className="px-2 py-1.5 justify-center items-center gap-1 flex">
                ...
                <NavLink to="/statistics" className="group self-stretch px-[9px] py-[5px] hover:px-2 hover:py-1 rounded hover:border hover:border-[#d9d9d9] justify-start items-center gap-2 inline-flex" style={linkStyle}>
                    <div className="w-5 h-5 relative" >
                        <svg className="fill-black" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <NavLink to="/notifications" className="group self-stretch px-[9px] py-[5px] hover:px-2 hover:py-1 rounded hover:border hover:border-[#d9d9d9] justify-start items-center gap-2 inline-flex" style={linkStyle}>
                    <div className="w-5 h-5 relative" >
                        <svg className="fill-black" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <NavLink to="/transfers" className="group self-stretch px-[9px] py-[5px] hover:px-2 hover:py-1 rounded hover:border hover:border-[#d9d9d9] justify-start items-center gap-2 inline-flex" style={linkStyle}>
                    <div className="w-5 h-5 relative" >
                ...
                <NavLink to="/profile" className="group self-stretch px-[9px] py-[5px] hover:px-2 hover:py-1 rounded hover:border hover:border-[#d9d9d9] justify-start items-center gap-2 inline-flex" style={linkStyle}>
                    <div className="w-5 h-5 relative" >
                        <svg className="fill-black" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
