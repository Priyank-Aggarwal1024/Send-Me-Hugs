...
import { FormLogo, smileLogo } from '../../assets';
...
function SideNav(props) {
    const linkStyle = ({ isActive }) => {
        return {
            ...
            color: isActive ? "black" : "#ababab",
            padding: isActive ? window.innerWidth > 844 ? "4px 8px" : "12px 13px" : window.innerWidth > 844 ? "5px 9px" : "13px 14px"
        }
    }
    ...
    return (
        <div className={`xlg:w-[260px] w-[59px] min-h-[100vh] h-[100%] pb-5 bg-white border-r border-[#d0d0d0] flex-col gap-[22px] flex`} >
            <div className="xlg:h-[68px] h-[56px] xlg:px-4 px-3 xlg:py-5 py-2.5 border-b border-[#d0d0d0] items-start gap-2.5 flex justify-between" >
                <img className="xlg:block hidden" src={FormLogo} alt="Image Fund" />
                <img className="xlg:hidden h-[35px] w-[35px]" src={smileLogo} alt="Image Fund" />
            </div>
            <div className="h-[310px] xlg:px-3 px-[7px] flex-col justify-start items-start gap-5 flex">
                <NavLink to="/dashboard" className="group self-stretch rounded justify-start items-center gap-2 inline-flex" style={linkStyle}>
                ...
                <NavLink to="/statistics" className="group self-stretch rounded justify-start items-center gap-2 inline-flex" style={linkStyle}>
                    <div className="w-5 h-5 relative" >
                        <svg className="fill-black" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <NavLink to="/notifications" className="group self-stretch rounded justify-start items-center gap-2 inline-flex" style={linkStyle}>
                    <div className="w-5 h-5 relative" >
                        <svg className="fill-black" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path d="M10.0002 18.3337C10.9196 18.3337 11.6719 17.5644 11.6719 16.6243H8.32852C8.32852 17.5644 9.08078 18.3337 10.0002 18.3337ZM15.0153 13.2055V8.93195C15.0153 6.30802 13.6528 4.11144 11.254 3.53024V2.94904C11.254 2.23964 10.694 1.66699 10.0002 1.66699C9.30646 1.66699 8.74644 2.23964 8.74644 2.94904V3.53024C6.35594 4.11144 4.98516 6.29947 4.98516 8.93195V13.2055L3.31348 14.9149V15.7696H16.6869V14.9149L15.0153 13.2055ZM13.3436 14.0602H6.65684V8.93195C6.65684 6.81229 7.91896 5.0858 10.0002 5.0858C12.0814 5.0858 13.3436 6.81229 13.3436 8.93195V14.0602Z" />
                        </svg>
                    </div>
                    <div className="px-2 py-1.5 justify-center items-center gap-1 xlg:flex hidden">
                        <div className="px-1 justify-start items-start gap-2.5 flex">
                            <div className="text-center text-sm font-medium font-inter leading-normal">Notifications</div>
                        </div>
                    </div>
                </NavLink>
                <NavLink to="/transfers" className="group self-stretch rounded justify-start items-center gap-2 inline-flex" style={linkStyle}>
                    <div className="w-5 h-5 relative" >
                ...
                <NavLink to="/profile" className="group self-stretch rounded justify-start items-center gap-2 inline-flex" style={linkStyle}>
                    <div className="w-5 h-5 relative" >
                        <svg className="fill-black" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
