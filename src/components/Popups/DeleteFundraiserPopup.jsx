...
function DeleteFundraiserPopup({ deletePopup, setDeletePopup }) {
    return (
        <div className="popup-animation max-w-[666px] w-[90%] max-h-[399px] h-full p-3 bg-white flex-col justify-start items-end gap-[77px] inline-flex">
            <div className="w-6 h-6 relative" onClick={() => setDeletePopup(!deletePopup)}>
                <img src={cross} alt="Cancel" />
            </div>
            <div className="self-stretch h-full py-[17px] flex-col justify-center gap-11 flex">
                ...
                <div className="self-stretch justify-center gap-3 sm:flex-row flex-col items-center inline-flex">
                    <button className="h-9 px-2 sm:w-[141px] w-full cursor-pointer py-1.5 bg-[#e5f8f4]/70 rounded-[36px] border-2 border-[#288d7c] justify-center items-center gap-1 flex">
                    ...
                    <div className="h-9 px-2 sm:w-[141px] w-full py-1.5 bg-gradient-to-b from-[#2dd6b4] to-[#21806f] rounded-[36px] justify-center items-center gap-1 cursor-pointer flex">
                        <div className="px-1 justify-start items-start gap-2.5 flex">
