                ...
                <div className="self-stretch h-[190px] py-[17px] flex-col justify-start items-center gap-11 flex">
                    <div className="self-stretch h-[76px] flex-col justify-start items-center gap-3 flex">
                        ...
                        <div className="justify-center items-center gap-2 inline-flex">
                            ...
                            <label htmlFor="fee" className="text-center text-[#6d6d6d] text-sm font-normal font-roboto leading-tight">I understand that Send me hugs should take  10% fee service</label>
                        </div>
                    </div>
                    <div className="self-stretch justify-center items-start gap-3 inline-flex">
                        ...
                        <div className="px-2 py-1.5 bg-gradient-to-b from-[#2dd6b4] to-[#21806f] rounded-[36px] justify-center items-center gap-1 flex">
