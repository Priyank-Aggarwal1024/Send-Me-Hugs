            ...
            <div className="fund-raising-form grid grid-cols-2 h-[100vh]">
                ...
                <form className="fund-raising-form-right col-span-2 xlg:col-span-1" action="#" method="POST" onSubmit={handleSubmit(onSubmit)} >
                    <Swiper modules={[Navigation, Pagination, A11y]} allowTouchMove={false} slidesPerView="auto" className="swiper" ref={swiper}>
                        <SwiperSlide>
                            <Step1 swiper={swiper} register={register} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <Step2 swiper={swiper} register={register} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <Step3 swiper={swiper} register={register} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <Step4 swiper={swiper} setValue={setValue} register={register} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <Step5 swiper={swiper} register={register} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <Step6 swiper={swiper} register={register} />
                        </SwiperSlide>
                        <SwiperSlide>
